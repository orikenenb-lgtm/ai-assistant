...
REVOKE EXECUTE ON FUNCTION public.enforce_customer_order_insert() FROM anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.enforce_customer_item_price() FROM anon, authenticated;
